...
public class KeyboardView extends RelativeLayout implements View.OnClickListener {
    ...
    private void initKeyboardButtons(KeyboardView view) {
        ...
        mButtons.add((KeyboardButtonView) view.findViewById(R.id.pin_code_button_10));//忘记密码
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.pin_code_button_10) {
            mKeyboardButtonClickedListener.onKeyboardClick(KeyboardButtonEnum.BUTTON_10);
