...
public class SPUtils {
    ...
    public static final String LOCKSMART = "lockSmart";//用户名
    public static final String SYSTEMAPP = "systemApp";                //密码
    public static final String THEMEDARK = "themeDark";//服务器地址
    ...
    private static SharedPreferences getSharedPreferences(Context context) {
        if (sp == null) {
            sp = context.getSharedPreferences("appLock", 0);
        }
    ...
    public static boolean remove(String KEY) {
        SharedPreferences sp = getSharedPreferences(UIUtils.getContext());
